...
# 2. Green: テストを通す最小限の実装を書く → テスト実行で成功を確認
# 3. Refactor: Green を維持しながらコードを改善
# 4. 繰り返す
...
- **設計**: 「Eric Evans の DDD に従ってください」
- **テスト戦略**: 「Martin Fowler の Test Pyramid に従ってください」
- **レガシーコード**: 「Michael Feathers のアプローチで進めてください」
